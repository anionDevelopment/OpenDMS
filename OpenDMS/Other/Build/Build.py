...
def build():
    ...
    pymupdf_version_file: str = GeneralUtilities.resolve_relative_path("Other/Resources/DependentCodeUnits/OpenDMSBackend/PyMuPDFVersion/PyMuPDFVersion.txt", codeunit_folder)
    pymupdf_version: str = GeneralUtilities.read_text_from_file(pymupdf_version_file)

    custom_args: dict[str, str] = dict[str, str]()
    custom_args["PYMUPDFVERSION"] = pymupdf_version
